    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', editable=False, to='reminder.NewsLetterTemplate')),
            ],
            options={
                'managed': True,
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(help_text=b'The strings {{ url }} and {{ unsubscribe_url }} may be used to refer to the profile url and unsubscribe url.')),
                ('language_code', models.CharField(max_length=15, db_index=True)),
                ('master', models.ForeignKey(related_name='translations', editable=False, to='reminder.NewsLetter')),
            ],
            options={
                'managed': True,
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manual_newsletter', models.ForeignKey(to='reminder.ManualNewsLetter')),
        ...
        migrations.AddField(
            ...
            name='template',
            field=models.ForeignKey(to='reminder.NewsLetterTemplate'),
        ),
        migrations.AddField(
            model_name='failedemail',
            name='manual_newsletter',
            field=models.ForeignKey(to='reminder.ManualNewsLetter'),
        ),
        migrations.AddField(
            model_name='failedemail',
            name='user',
