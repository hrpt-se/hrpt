...
class SiteSettings(models.Model):
    ...
    logo = models.ImageField(_("Logo"), help_text=_("Preferred height: 70px, maximum width: 756px"),
                             upload_to='uploads', blank=True, null=True)
    light_color = models.CharField(max_length=6, default="ce2626")
    footer = models.TextField(_("Footer"), help_text=_("The footer will be displayed at the bottom of each page"),
